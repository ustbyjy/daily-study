...
public class Dom4jTest {
    ...
    public void test() throws Exception {
        ...
        Document document = reader.read(new File(this.getClass().getClassLoader().getResource("sida.xml").getFile()));
        // 获取根节点元素对象
    ...
    public void testValidate() {
        try {
            ...
            // 通过read方法读取一个文件 转换成Document对象
            Document document = reader.read(new File(this.getClass().getClassLoader().getResource("eg.xml").getFile()));
